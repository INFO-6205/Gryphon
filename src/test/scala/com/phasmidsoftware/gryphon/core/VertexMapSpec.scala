...
class VertexMapSpec extends AnyFlatSpec with should.Matchers {
    ...
    it should "dfs" in {
        import Journal._
        val vertexMap: VertexMap[String, DirectedEdgeCase[String, Int]] = OrderedVertexMap.empty
    ...
    it should "keys" in {
        val target: VertexMap[String, DirectedEdgeCase[String, Int]] = OrderedVertexMap.empty
